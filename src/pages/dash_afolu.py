...
df = pd.read_csv("~/project/src/data/afolu_output.csv")
df2 = pd.read_csv("~/project/src/data/TNC/afolu_historical.csv")
...
def update_graph(
    ...
    df2 = pd.read_csv("~/project/src/data/TNC/" + dataset2 + ".csv")
